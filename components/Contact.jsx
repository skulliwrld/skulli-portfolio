...
function Contact() {
  ...
  return (
    <section className= 'grid md:grid-cols-2 py-12 md:my:12 gap-4 relative' id="contact">
        ...
        <div className="mb-4 mr-4">
            ...
            <p className="text-[#ADB7BE] mb-4 mzx-w-md">im currently looking for new opportunities , my inbox is alway open. Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 px-0'>
        ...
        <button className="py-6 px-2 text-2xl rounded-full font-bold bg-primary-700 text-white w-full hover:bg-[#ADB7BE] hover:text-black" type="submit">
            Send
        </button>
