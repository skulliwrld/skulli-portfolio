  ...
  return (
    <section className="lg:py-16">
        ...
        className='col-span-8 place-self-center mb-4 text-center sm:text-left'>
                <h1 className='text-white mb-4 text-4xl font-extrabold md:text-5xl lg:text-8xl justify-self-start'>
            ...
            <div className="mt-10">
                <Link href={"https://drive.google.com/file/d/1hxGohbLXAGx8TuFGZCmW1emrtlYhhoi-/view?usp=sharing"}>
                ...
                <a href="https://drive.google.com/file/d/1hxGohbLXAGx8TuFGZCmW1emrtlYhhoi-/view?usp=sharing">
